      ...
      <div class="lg:px-26 md:px-18 px-3 py-12 grid lg:grid-cols-5 sm:grid-cols-3 grid-cols-2 gap-5">
        ...
        <div class="px-5 py-3 flex items-center ">
          <svg
            ...
            stroke-width="1.5"
            stroke="currentColor"
            class="md:w-6 md:h-6 w-5 h-5 inline text-green-600"
          >
            <path
        ...
        <div class="px-5 py-3 flex items-center ">
          ...
          <span class=" ml-1 text-sm ">CSS</span>
        </div>
        <div class="px-5 py-3 flex items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class=" ml-1 text-sm ">JAVASCRIPT</span>
        </div>
        <div class="px-5 py-3 flex items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class=" ml-1 text-sm ">BOORSTRAP</span>
        </div>
        <div class="px-5 py-3 flex items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class=" ml-1 text-sm ">TAILWIND</span>
        </div>
        <div class="px-5 py-3 flex items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class=" ml-1 text-sm ">JQUERY</span>
        </div>
        <div class="px-5 py-3 flex items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class=" ml-1 text-sm ">VUE</span>
        </div>
        <div class="px-5 py-3 flex items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class=" ml-1 text-sm ">PHP</span>
        </div>
        <div class="px-5 py-3 flex items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class=" ml-1 text-sm ">LARAVEL</span>
        </div>
        <div class="px-5 py-3 flex items-center ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span class=" ml-1 text-sm ">MYSQL</span>
        </div>
      </div>
    </div>
  </section>
